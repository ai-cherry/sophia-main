...
from mcp_base import MCPServer, Resource, Tool
...
class SnowflakeMCPServer(MCPServer):
            ...
            Tool(
                ...
                parameters={
                    ...
                    "data": {
                        "type": "array",
                        "required": True,
                        "description": "Data as array of objects",
                    },
                    "if_exists": {
                        "type": "string",
                        "default": "append",
                        "description": "append, replace, or fail",
                    },
                    "schema": {
                        "type": "string",
                        "description": "Schema name (optional)",
        ...
        try:
            if self.auth_method == "keypair":
                ...
                if not private_key_path:
                    raise ValueError(
                        "SNOWFLAKE_PRIVATE_KEY_PATH not set for keypair auth"
                    )
            ...
            if "Multi-factor authentication is required" in str(e):
                self.logger.error(
                    "MFA is required. Please use key pair or OAuth authentication."
                )
            raise
    ...
    async def upload_dataframe(
        ...
        try:
            ...
            if success:
                return {"success": True, "rows_uploaded": nrows, "chunks": nchunks}
            else:
